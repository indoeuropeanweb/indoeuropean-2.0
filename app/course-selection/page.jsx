          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mt-10">
              {courseSelectionPoints.map((point, index) => {
                ...
                return <ScrollAnimate direction='down' key={point.id}>
                          ...
                          <div className="ms-16">
                              <h6 className="text-md lg:text-base font-Jakarta font-bold text-white">{point.title}</h6>
                              <p className="text-xs text-white font-manrope mt-1">{point.description}</p>
                          </div>
                      </div>
                      </ScrollAnimate>
              })}
