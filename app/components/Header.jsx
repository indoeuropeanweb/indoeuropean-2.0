...
const Header = () => {
  ...
  const [europeDestionations, setEuropeDestinations] = useState(false);


  //close destination links popup 
  const closeDestinationsPopup = () => {
    setDestinationsOpen(false);
    setEuropeDestinations(false);
  }
  ...
  return (
    ...
    <div className="justify-between items-center bg-primary px-5 hidden lg:flex">
        ...
        <div className="grid grid-cols-2 gap-2 justify-center items-center">
             <div className="">
                <Link className="text-white text-sm flex justify-center items-center gap-2 font-Jakarta" href="tel:+919650133355"><FaWhatsapp className="size-5 inline-block"/>&nbsp;+91 9650133355</Link>
             </div>
    ...
    <div className="flex justify-between items-center px-5 py-3">
      ...
      <ul className="lg:flex justify-center items-center gap-5 hidden">
              ...
              <li className="relative group" onMouseEnter={() => setDestinationsOpen(true)} onMouseLeave={() => {setDestinationsOpen(false), setEuropeDestinations(false)}}>
                ...
                {destinationsOpen && <ul className="absolute z-2 p-5 grid grid-cols-1 md:grid-cols-2 space-x-4 space-y-4 top-full left-0 rounded-md bg-white w-120 shadow-xl transition-all duration-500 ease-in-out">
                    <li onMouseEnter={() => setEuropeDestinations(true)} onMouseLeave={() => setEuropeDestinations(false)} className="relative font-Jakarta group/europe"><Link className="flex items-center hover:bg-primary/5 border-s-2 border-white hover:border-primary transition-colors duration-300 ease-in-out rounded-md px-2 py-2 text-sm lg:text-md" href="/destinations/study-in-ireland"><Image className="rounded-full w-5 h-5" src={'/images/flags/europe.svg'} width={5} height={5} alt="study in europe"/>&nbsp;&nbsp;Study in Europe &nbsp;<MdKeyboardArrowDown className="size-4 inline-block group-hover/europe:rotate-180 transition-all duration-300 ease-in-out"/></Link>
                    {europeDestionations && <ul className="absolute z-5 p-5 grid grid-cols-1 md:grid-cols-2 space-x-4 space-y-4 top-0 right-0 rounded-md bg-white w-120 shadow-xl transition-all duration-500 ease-in-out">
                      <li className="font-Jakarta" onClick={closeDestinationsPopup}><Link className="flex items-center hover:bg-primary/5 border-s-2 border-white hover:border-primary transition-colors duration-300 ease-in-out rounded-md px-2 py-2 text-sm lg:text-md" href="/destinations/study-in-latvia"><Image className="rounded-full w-5 h-5" src={'/images/flags/latvia.svg'} width={5} height={5} alt="study in latvia"/>&nbsp;&nbsp;Study in Latvia</Link></li>
      ...
      Contact Us
        ...
        <div className="grid grid-cols-1 mt-8 space-y-8 justify-center items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
                ...
                <Link className="text-white text-xs flex justify-center items-center gap-2 font-Jakarta" href=""><FaWhatsapp className="size-5 inline-block"/>&nbsp;+91 9650133355</Link>
          </div>
        </div>
  </nav>
  </div>
